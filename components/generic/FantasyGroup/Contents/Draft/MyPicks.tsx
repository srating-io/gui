...
const MyPicks = () => {
  ...
  const fantasy_entry_id_x_fantasy_entry_players: {[fantasy_entry_id: string]: Fantasy.FantasyEntryPlayers} = {};
  const fantasy_entry_id_x_fantasy_draft_orders: {[fantasy_entry_id: string]: Fantasy.FantasyDraftOrders} = {};
